# Contributing to `libiui`

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [libiui](https://github.com/sysprog21/libiui)
...
Visit our [Issues page on GitHub](https://github.com/sysprog21/libiui/issues) to search and submit.
